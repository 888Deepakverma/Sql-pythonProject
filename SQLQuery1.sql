...
--find top 10 hisgest revenue generating products
...
select order_month
, sum(case when order_year=2022 then sales else 0 end) as slaes_2022
, sum(case when order_year=2023 then sales else 0 end) as slaes_2023
from cte
...
--which sub categor	had highest growth by profit in 2023 compare  to 2022
